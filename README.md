This app can be used to show weather of a city. User can either search for a city manually or app uses location of the device to fetch weather of a location.
